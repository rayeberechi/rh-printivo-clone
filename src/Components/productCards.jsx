  ...
  return (
    <div className="products-container">
      <div className="card">
        ...
        <a href="#" className="btn">Browse Two Sided B..</a>
      </div>
      ...
      <div className="card">
        ...
        <a href="#" className="btn">Browse A5 Flyers</a>
      </div>
      ...
      <div className="card">
        ...
        <a href="#" className="btn">Browse Round Stic..</a>
      </div>
      ...
      <div className="card">
        ...
        <a href="#" className="btn">Browse Simple Mu..</a>
      </div>
      ...
      <div className="card">
        ...
        <a href="#" className="btn">Browse Postcards</a>
      </div>
      ...
      <div className="card">
        ...
        <a href="#" className="btn">Browse Roll-up Ba..</a>
      </div>
      ...
      <div className="card">
        ...
        <a href="#" className="btn">Browse A2 Pos..</a>
      </div>
      ...
      <div className="card">
        ...
        <a href="#" className="btn">Browse Trifold Broc..</a>
      </div>
      ...
      <div className="card">
        ...
        <a href="#" className="btn">Browse Landscape..</a>
      </div>
      ...
      <div className="card">
        ...
        <a href="#" className="btn">Browse Off-white T..</a>
      </div>
      ...
      <div className="card">
        ...
        <a href="#" className="btn">Browse A4 Branded..</a>
      </div>
      ...
      <div className="card">
        ...
        <a href="#" className="btn">Browse A4 Courier..</a>
      </div>

      <div className="sub-nav sub2">
      ...
      <div className="products-container box2">
        <div className="card">
          ...
          <a href="#" className="btn">Browse Greeting ..</a>
        </div>
        ...
        <div className="card">
          ...
          <a href="#" className="btn">Browse Stickers</a>
        </div>
      </div>
    </div>
  );
